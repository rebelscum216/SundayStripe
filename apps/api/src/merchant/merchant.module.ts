...
import { MerchantSchedulerService } from './merchant-scheduler.service.js';
...
@Module({
  ...
  providers: [MerchantApiService, MerchantSyncService, MerchantSyncProcessor, MerchantSchedulerService],
  exports: [MerchantApiService, MerchantSyncService, MerchantSchedulerService],
})
