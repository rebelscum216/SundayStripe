...
<style>
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .chart-reveal {
    ...
    transform: scaleX(0);
    animation:revealChart 2.4s cubic-bezier(.16,1,.3,1) .45s forwards;
  }
  .chart-path, .chart-path-2 {
    stroke-dasharray:900;
    stroke-dashoffset:900;
    animation:drawLine 2.45s cubic-bezier(.16,1,.3,1) .45s forwards;
  }
  .chart-path-2 {
    animation-delay:.62s;
  }
    ...
    <svg viewBox="0 0 460 112" fill="none" style="width:100%;display:block;">
      ...
      <g clip-path="url(#chartClip)">
        ...
        <path class="chart-path"
              d="M34,86 L34,62 L48,86 L62,86 L76,62 L90,86 L104,86 L118,62 L132,86 L146,86 L160,14 L174,86 L188,86 L202,62 L216,86 L230,62 L244,86 L258,14 L272,86 L286,86 L300,86 L314,86 L328,62 L342,86 L356,86 L370,86 L384,86 L398,14 L412,50 L426,86"
              stroke="#f45b52" stroke-width="2.8" fill="none" stroke-linecap="round" stroke-linejoin="round"/>
        <path class="chart-path-2"
              d="M34,86 L48,53 L62,64 L76,57 L90,64 L104,64 L118,36 L132,44 L146,60 L160,76 L174,82 L188,24 L202,44 L216,14 L230,53 L244,47 L258,36 L272,86 L286,78 L300,78 L314,67 L328,60 L342,47 L356,26 L370,78 L384,65 L398,73 L412,69 L426,78"
              stroke="#818cf8" stroke-width="2.6" fill="none" stroke-linecap="round" stroke-linejoin="round"/>
      </g>
      <g style="opacity:.9;">
